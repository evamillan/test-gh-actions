...
RUN opensearch-dashboards-plugin install https://github.com/evamillan/bitergia-analytics-plugin/releases/download/0.5.0/bitergia_analytics-0.5.0_2.7.0.zip
